...
public class TodayEventAdapter extends RecyclerView.Adapter<TodayEventAdapter.mViewHolder> {
    private List<Map<String, Object>> list;
    private Context context;

    public TodayEventAdapter(List<Map<String, Object>> list, Context context) {
        this.list = list;
